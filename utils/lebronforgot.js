...
async function markupText(forgot) {
	...
	let markupedText = '<span foreground="#ed8148">LEBRON JAMES </span><span foreground="white">REPORTEDLY </span><span foreground="#ed8148">FORGOT </span>';
...
async function lebronforgot(image, forgot) {
	...
	// Overlaid Image
	await sharp(blackBackgroundPath).composite([
